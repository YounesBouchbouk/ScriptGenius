        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          ...
          >
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2 className="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-mainFontColor">
                GET IN TOUCH WITH US
              </h2>
              <p className="text-body-color mb-9 text-base leading-relaxed">
                Your well-being matters to us. Reach out to us and let us
                support you on your path to mental wellness.
              </p>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-body-color text-base">+212 680413729</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
